...
extern "C" DOBOTDLLSHARED_EXPORT int ConnectDobot(const char *portName, uint32_t baudrate, char *fwType, char *version, float *time);
...
extern "C" DOBOTDLLSHARED_EXPORT int GetDeviceVersion(uint8_t *majorVersion, uint8_t *minorVersion, uint8_t *revision, uint8_t *hwVersion);

extern "C" DOBOTDLLSHARED_EXPORT int SetDeviceWithL(bool isWithL, uint8_t version, bool isQueued, uint64_t *queuedCmdIndex);
...
extern "C" DOBOTDLLSHARED_EXPORT int GetDeviceInfo(DeviceCountInfo *deviceInfo);
...
extern "C" DOBOTDLLSHARED_EXPORT int SetColorSensor(bool enable, ColorPort colorPort, uint8_t version);
extern "C" DOBOTDLLSHARED_EXPORT int GetColorSensor(uint8_t *r, uint8_t *g, uint8_t *b);

extern "C" DOBOTDLLSHARED_EXPORT int SetInfraredSensor(bool enable, InfraredPort infraredPort, uint8_t version);
...
extern "C" DOBOTDLLSHARED_EXPORT int GetQueuedCmdMotionFinish(bool *isFinish);
//parker add ?置debug?出使能
extern "C" DOBOTDLLSHARED_EXPORT bool SetDebugEnable(bool flag = false);
